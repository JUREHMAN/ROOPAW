...
%cut all_sig_side_cut Ycut&&Mbc_sig_cut&&deltaE_sig_cut1&&deltaE_sig_cut2&&sin_cut&&m_Dcut
%cut add_cut sin_cut
...
%ntpl sig nPhotonsSelected all_sig_side_cut h1
%ntpl mc nPhotonsSelected all_sig_side_cut h2 

#Setting the title
h2.SetTitle("Number of photons with rank1,Mbc_Bsig>5.27,-0.050<deltaE_Bsig<0.050,abs(m_D-1.86)<0.015 and abs(sin_phi)<1")
